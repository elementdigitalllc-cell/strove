    ...
    <div className="relative min-h-dvh bg-black text-white font-sans px-6 py-12 flex justify-center">
      ...
      <div className="w-full max-w-[400px]">
        ...
        <form onSubmit={onSubmit} className="mt-8 flex flex-col gap-5">
          <OtpBoxes code={code} setCode={setCode} hasError={!!error} />
...
function OtpBoxes({ code, setCode, hasError }) {
  const refs = useRef([]);
    ...
    <div className="flex gap-2 justify-between">
      {Array.from({ length: 6 }).map((_, i) => (
        <input
          ...
          className={
            'w-12 h-14 text-center text-[22px] font-semibold rounded-[8px] bg-[#111] border text-white outline-none transition-colors focus:border-orange ' +
